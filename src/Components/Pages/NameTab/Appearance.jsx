...
const Appearance = () => {
    ...
    return (
        <div id="name_Appearance" className="tab-pane fade">
            <div className="row px-2">
                <div className="col-12 d-flex py-1 px-2" style={{ background: '#eee', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span>Appearance</span>
                    {/* <button className='btn btn-sm bg-green text-white py-0'><i className="fa fa-plus"></i></button> */}
                </div>
            </div>
            <div className="row">
                        <div className="col-12">
                            <div className="row mt-3">
                                ...
                                <div className="col-12 mt-3">
                                    ...
                                    <button className="btn btn-sm bg-green text-white ml-2">Add Appearance</button>
                                </div>
                            </div>
                        </div>
